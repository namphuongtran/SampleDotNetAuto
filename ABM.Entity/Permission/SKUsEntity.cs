...
{
    public class SKUsEntity : BaseEntity
    {
        ...
        public string ImageStatus
        {
            get {
                ...
                {
                    return isDeleted ? "<button type='button' data-placement='top' title='Tạm dừng' class='btn btn-icon btn-default tip'><i class='icon-cancel-circle'></i></button>"
