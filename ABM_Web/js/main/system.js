    ...
    category: {
        ...
        manipulate: function (action, id) {
            ...
            switch (action) {
                ...
                case systemConfig.action.save:
                    var status = $(systemConfig.ddlStatus).val() == 2 ? false : true; // 2 - Active| 1 - Not Active 
                    params = $.extend(params, $(systemConfig.modal.form).serializeObject(),
                                        {
    ...
    product: {
        ...
        manipulateRelated: function (obj) {
            ...
            if (skuId > 0) {
                ...
                var params = { Action: action, SKUIDMain: skuId };
                ...
                $.jGrowl("Bạn cần 'Lưu lại' sản phẩm.", { sticky: false, theme: 'growl-warning', header: 'Thông báo' });            
        },
        ...
        saveImage: function () {            
            ...
            if (skuId > 0 && params != null && params.length > 0) {
                ...
                $.jGrowl("Bạn cần 'Lưu lại' sản phẩm hoặc nhấn vào biểu tượng '+' để chọn ảnh.", { sticky: false, theme: 'growl-warning', header: 'Thông báo' });            
        },
        ...
        saveDocument: function() {
            ...
            if (skuId > 0 && params != null && params.length > 0) {
                ...
                $.jGrowl("Bạn cần 'Lưu lại' sản phẩm hoặc nhấn vào biểu tượng '+' để chọn tài liệu.", { sticky: false, theme: 'growl-warning', header: 'Thông báo' });
        },
